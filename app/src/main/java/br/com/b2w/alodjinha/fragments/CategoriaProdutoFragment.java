package br.com.b2w.alodjinha.fragments;
...
import br.com.b2w.alodjinha.MainActivity;
import br.com.b2w.alodjinha.R;
import br.com.b2w.alodjinha.adapters.ProdutoAdapter;
import br.com.b2w.alodjinha.common.BackPressedFragment;
import br.com.b2w.alodjinha.common.ErroWs;
import br.com.b2w.alodjinha.common.PaginationScrollListener;
import br.com.b2w.alodjinha.models.Produto;
import br.com.b2w.alodjinha.network.AsyncTaskCompleteListener;
import br.com.b2w.alodjinha.network.WebService;
...
public class CategoriaProdutoFragment extends BackPressedFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    @BindView(R.id.rvProduto) public RecyclerView rvProduto;
    @BindView(R.id.pbProgresso) public ProgressBar pbProgresso;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_categoria_produto, container, false);
    ...
    private void carregaListaProdutoWs() {
        new WebService(new AsyncTaskCompleteListener<String>() {
            @Override
